...
<?php include('../includes/body-left-admin.php');?>
    ...
    <br />
				...
				if(isset($_GET['editid'])){
						...
						$get_query = "Select * from mathang where ID_MatHang = '$edit_id'";
					...
					if($_SERVER['REQUEST_METHOD'] == 'POST'){//neu gia tri ton tai thi xu ly form
						...
						if(empty($errors)){
							...
							$query_dh = "Update mathang set ID_MatHang = '$mamh',TenMatHang = '$tenmh',
							ID_NSX = '$mansx',ID_DacDiem = '$madd',
							SoLuong = $soluong,GiaNhap = $gianhap,GiaXuat = $giaxuat,NgayThang = now(),
							image = '$image' where ID_MatHang = '$edit_id'";
							...
							if(mysql_affected_rows() == 1){
								...
								echo "<script>window.open('viewMatHang.php?act=mh','_self')</script>";
							}else{
    	...
    	<table width="600" align="center" border="5">
        	<tr>
            	<td align="center" bgcolor="#FFCBA0" colspan="6"><h1>Sửa thông tin mặt hàng</h1></td>
            </tr>
            <tr>
            ...
            <tr>
             ...
             <tr>
                ...
                <td><input type="file" name="image"  ><?php echo $image;?><img src="images/<?php echo $image;?>" width="100px" height="100px"></td>
            </tr>
            <tr>
                <td align="center" colspan="6"><input type="submit" name="submit" value="Cập nhật" ></td>
            </tr>
        </table>
    </form>
    <?php }?>
