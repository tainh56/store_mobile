...
<?php include('../includes/body-left-admin.php');?>
    ...
    <div id="form">
    <h2>Thêm đơn hàng xuất chi tiết</h2>
    <br />
    <br />
                <?php 
					if($_SERVER['REQUEST_METHOD'] == 'POST'){//neu gia tri ton tai thi xu ly form
						...
						if(empty($errors)){
							...
							hoadonban(ID_DH,ID_MatHang,ID_KhachHang,SoLuong,GiaBan,Thue) 
							values('$madh','$mamh','$makh',$soluong,$gia,$thue)";
                ...
                <form id="add_cat" action="" method="post">
                	<fieldset>
                    	<legend>Thêm đơn hàng bán chi tiết</legend>
                        	<div align="center">
                       ...
                       <div align="center">
                            ...
                            <select name="mamh" tabindex="3">
                            	<?php
                                $q_makh = "Select ID_MatHang from mathang";
								$r_makh = mysql_query($q_makh);								
									if(mysql_num_rows($r_makh) != 0){
										while($num = mysql_fetch_array($r_makh)){
                       ...
                       <div align="center">
                        	<label for="makh">Mã Khách Hàng: <span class="required">*</span>
                            	<?php
                                	if(isset($errors) && in_array('makh',$errors)){
										echo "<p class='warning'>Bạn chưa chọn mã khách hàng.</p>";
									}
								?>
                            </label>
                        ...
                        <div align="center">
                        	<label for="gia">Giá Bán: <span class="required">*</span>
                            	<?php
                    ...
                    <p align="center"><input type="submit" name="submit" value="Thêm đơn hàng CT" /></p>
