...
<?php
	...
	if(isset($_GET['del_id'],$_GET['del_name'])){
		$del_id = $_GET['del_id'];
	...
	if(isset($_GET['del_id'],$_GET['del_name'])){
		...
		if($_SERVER['REQUEST_METHOD'] == 'POST'){
			if(isset($_POST['delete']) && $_POST['delete'] == 'yes'){
				$del_query = "Delete from nhasanxuat where ID_NSX='$del_id'";
...
?>
    <h2>Xóa Nhà cung cấp: <?php if(isset($del_name)) echo htmlentities($del_name,ENT_COMPAT,'UTF-8');?></h2>
    <?php if(!empty($message)) echo $message;?>
    <br />
    <br />
    <form action="" method="post">
    	<fieldset>
        	<legend>Xóa NCC</legend>
