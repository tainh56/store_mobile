	...
	if(isset($_GET['del_id'])){
		...
		if($_SERVER['REQUEST_METHOD'] == 'POST'){
			if(isset($_POST['delete']) && $_POST['delete'] == 'yes'){
				$del_query = "Delete from dacdiem where ID_DacDiem='$del_id'";
...
?>
    <h2>Xóa đặc điểm mặt hàng: <?php if(isset($del_name)) echo htmlentities($del_name,ENT_COMPAT,'UTF-8');?></h2>
    <?php if(!empty($message)) echo $message;?>
    <br />
    <br />
    <form action="" method="post">
    	<fieldset>
        	<legend>Xóa DDMH</legend>
