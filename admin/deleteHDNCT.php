	...
	if(isset($_GET['del_id'])){
		...
		if($_SERVER['REQUEST_METHOD'] == 'POST'){
			if(isset($_POST['delete']) && $_POST['delete'] == 'yes'){
				$del_query = "Delete from hoadonnhap where ID_DH='$del_id'";
...
?>
    <h2>Xóa hóa đơn nhập CT: <?php if(isset($del_name)) echo htmlentities($del_name,ENT_COMPAT,'UTF-8');?></h2>
    <?php if(!empty($message)) echo $message;?>
    <br />
    <br />
    <form action="" method="post">
    	<fieldset>
        	<legend>Xóa HDNCT</legend>
